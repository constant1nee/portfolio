...
class SignInWindow:
    ...
    def draw_title(self):
        ...
        title = self.font.render('Sign In', True, '#f5e49c')
...
class Button(pygame.sprite.Sprite):
    def __init__(self, group, x, y, btn_passive, btn_active, on_click):
        ...
        self.rect = self.image.get_rect(center=(y, 350 + x))
...
button = Button(all_sprites, 0, 250, passive_confirm_btn, active_confirm_btn, add_info)
